Instructions to build and run the program on Linux platform. (Just follow CMake and linker errors)
(Tested on: Fedora)
...
Example for connecting to above mentioned server: ./client_main -i localhost -p 2061 -n Lukas -t Developers -w 500 -h 500
