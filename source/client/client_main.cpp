...
int main(int argc, const char **argv) {
  ...
  desc.add_options()("ip", po::value<std::string>()->default_value("localhost"),
                     "Server address")(
      "port,p", po::value<std::string>()->default_value("2061"),
      "Server port")("player-name,n", po::value<std::string>()->required())(
